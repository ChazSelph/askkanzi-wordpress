...
<body>
	    ...
	    <nav class="navbar navbar-expand-lg navbar-dark" >
			...
			<div id="navigation" class="collapse navbar-collapse flex-column" >
				...
				<ul class="navbar-nav flex-column text-sm-center text-md-left">
					...
					<li class="nav-item">
					    <a class="nav-link" href="post.html"><i class="fas fa-file-alt fa-fw mr-2"></i>Posts</a>
					</li>
					<li class="nav-item">
					    <a class="nav-link" href="page.html"><i class="fas fa-file-image fa-fw mr-2"></i>Pages</a>
					</li>
					<li class="nav-item">
					    <a class="nav-link" href="archive.html"><i class="fas fa-archive fa-fw mr-2"></i>Archive</a>
					</li>
					<li class="nav-item">
    ...
    <div class="main-wrapper">
	    ...
	    <footer class="footer text-center py-2 theme-bg-dark">
            ...
            <p class="copyright"><a href="https://chazselph.github.io">Ask Kanzi</a></p>
